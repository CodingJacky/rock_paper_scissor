...
rockHandPlayer = PhotoImage(file = './images/rockHandPlayer.png')
paperHandPlayer = PhotoImage(file = './images/paperHandPlayer.png')
scissorHandPlayer = PhotoImage(file = './images/scissorHandPlayer.png')

rockHandComputer = PhotoImage(file = './images/rockHandComputer.png')
paperHandComputer = PhotoImage(file = './images/paperHandComputer.png')
scissorHandComputer = PhotoImage(file = './images/scissorHandComputer.png')
cMessagePhoto = PhotoImage(file = './images/cMessage.png')

winPhoto = PhotoImage(file = './images/win.png')
loosePhoto = PhotoImage(file = './images/loose.png')
tiePhoto = PhotoImage(file = './images/tie.png')
resMessagePhoto = PhotoImage(file = './images/resMessage.png')
